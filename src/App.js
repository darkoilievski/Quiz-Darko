    ...
    <main>
      ...
      {gameStarted ? (
        ...
        <section className='game-intro'>
          <h1 className='game-title'>Darko's Quiz</h1>
          <p className='game-text'>
            Answer the questions and test your knowledge!
            <hr />
            Choose your category, difficulty, type of question and get ready to
            have fun.
          </p>
      ...
      <footer>
        Developed by
        <a href='https://darkos-portfolio.netlify.com'>Darko Ilievski</a>
      </footer>
    </main>
  );
};
